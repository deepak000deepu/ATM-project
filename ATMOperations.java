...
import com.codegnan.customExceptions.IncorrectPinLimitReachException;
...
public static HashMap<Long, ATMService> dataBase = new HashMap<>();
...
public static ATMService card;
// Validate the inserted card by checking against the database
public static ATMService validateCard(long cardNumber) throws InvalidCardException {
...
public static void resetUserAttempts(ATMService operatorCard) {
ATMService card = null;
long number;
...
public static ATMService validateCredentials(long cardNumber, int pinNumber)
throws InvalidCardException, IncorrectPinLimitReachException, InvalidPinException {
if (dataBase.containsKey(cardNumber)) {
...
throw new IncorrectPinLimitReachException(
...
public static void operatorMode(ATMService card) {
Scanner scanner = new Scanner(System.in);
double amount;
boolean flag = true;
while (flag) {
...
} catch (InvalidPinException | InvalidCardException | IncorrectPinLimitReachException e) {
